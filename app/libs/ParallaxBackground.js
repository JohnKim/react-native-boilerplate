...
export default class ParallaxBackground extends Component {
  ...
  static propTypes = {
    ...
    offset: React.PropTypes.number, //Animated.Value,
    backgroundImage: React.PropTypes.number,
    backgroundShift: React.PropTypes.number, // 0..1
    backgroundColor: React.PropTypes.number, // TODO: This makes it seems like image loads faster. Remove
    children: any,
  };
